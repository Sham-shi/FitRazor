            ...
            if (!await context.Trainers.AnyAsync())
            {
                ...
                var trainers = new List<Trainer>
                {
                    new Trainer
                    {
                        ...
                        SpecializationDescription = "Постановка техники в базе (жим, присед, тяга) и построение силы, которая останется с тобой навсегда. Его атлеты не боятся весов.",
                    ...
                    new Trainer
                    {
                        ...
                        SpecializationDescription = "Специалист по высокоинтенсивным интервальным тренировкам (HIIT), работе с собственным весом и функциональному развитию.",
                    ...
                    new Trainer
                    {
                        ...
                        SpecializationDescription = "Эксперт в построении мышечной массы, работе на рельеф и изоляции мышц. Он знает, как «добить» каждую мышечную группу для идеальной формы.",
                    ...
                    new Trainer
                    {
                        ...
                        SpecializationDescription = "Специализация: постановка техники в базовых движениях (присед, тяга, жим, рывок, толчок) и развитие прикладной силы. Особый фокус — тренировки для женщин.",
                    ...
                    new Trainer
                    {
                        ...
                        SpecializationDescription = "Эксперт по экстремальной «сушке», работе на рельеф, ментальной подготовке и соревновательной диетологии.",
